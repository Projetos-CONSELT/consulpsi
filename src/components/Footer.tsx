        ...
        <div className="grid grid-cols-1 items-start gap-12 sm:grid-cols-2 sm:gap-10 lg:grid-cols-4 lg:gap-8">
              ...
              {servicosItems.map((item) => (
                <li key={item}>
                  <button
                    ...
                    className="text-sm font-body text-primary-foreground/70 hover:text-[#FFB964] hover:translate-x-1 transition-all duration-300 ease-out relative after:absolute after:bottom-0 after:left-0 after:w-0 hover:after:w-full after:h-px after:bg-[#FFB964]/50 after:transition-all after:duration-300 text-left"
                  >
                    {item}
                  </button>
                </li>
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-sm font-body text-primary-foreground/70 mb-5">
                ...
                <li>
                  <a
                    ...
                    className="inline-block leading-relaxed relative transition-all duration-300 hover:text-[#FFB964] hover:translate-x-1 after:absolute after:bottom-0 after:left-0 after:w-0 hover:after:w-full after:h-px after:bg-[#FFB964]/50 after:transition-all after:duration-300"
                  >
              ...
              <div className="flex items-center gap-4">
                <a
                  ...
                  className="text-primary-foreground/60 hover:text-[#FFB964] hover:scale-110 transition-all duration-300"
                >
          ...
          <div className="footer-mobile-panel max-w-[22rem] mx-auto sm:max-w-none sm:mx-0">
            ...
            <div className="rounded-lg overflow-hidden border border-[#FFB964]/20 shadow-md">
              <iframe
                src="https://www.google.com/maps?q=Bloco+2E+-+Agronomia+UFU&output=embed"
                width="100%"
                height="170"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="Localização Consulpsi — Bloco 2E - Agronomia UFU"
              />
            </div>
          </div>
        </div>
