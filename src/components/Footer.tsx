import footerLogo from "@/assets/logo-consulpsi-footer.png";
...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-brand-dark text-primary-foreground overflow-hidden">
      ...
      <div
        className="container mx-auto flex flex-wrap justify-between items-start gap-12 px-10 md:px-20 py-14"
      >
        {/* Bloco 1 — Logo */}
        <div className="flex items-start" style={{ flex: "0 0 auto" }}>
          <img
            src={footerLogo}
            alt="Consulpsi"
        ...
        <div style={{ flex: "1.2", minWidth: "260px" }}>
          ...
          <ul className="space-y-2.5 text-sm font-body text-primary-foreground/70 mb-5">
            <li style={{ wordBreak: "break-word", lineHeight: 1.5 }}>
              <a
      ...
      {/* Copyright */}
      <div className="border-t border-accent/15 py-6 text-center">
