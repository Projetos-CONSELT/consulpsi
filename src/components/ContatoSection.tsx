        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="flex gap-4 mt-8">
              ...
              <a href="https://www.linkedin.com/company/consulpsi-empresa-júnior/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-primary flex items-center justify-center text-primary-foreground hover:bg-brand-medium transition-colors" aria-label="LinkedIn">
