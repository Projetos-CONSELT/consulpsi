  ...
  return (
    <section id="contato" className="py-20 bg-card">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        >
          <p className="font-accent text-brand-accent text-lg mb-2">Entre em contato</p>
          ...
          >
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <span className="text-foreground font-body text-sm">consulpsi@ufu.br</span>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center">
                  <Phone className="text-primary" size={18} />
                </div>
                <span className="text-foreground font-body text-sm">(34) 99999-0000</span>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center">
                  <MapPin className="text-primary" size={18} />
                </div>
                <span className="text-foreground font-body text-sm">Universidade Federal de Uberlândia</span>
              </div>
            </div>
            ...
            <div className="flex gap-4 mt-8">
              ...
              <a href="https://linkedin.com/company/consulpsi" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-primary flex items-center justify-center text-primary-foreground hover:bg-brand-medium transition-colors" aria-label="LinkedIn">
